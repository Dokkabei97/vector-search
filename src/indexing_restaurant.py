...
model_id = "YZqEdZYBZEYbT8VB5-vK"

pipeline = "bert-pipeline2"
pipeline_body = {
...
restaurant_data_list = [
    ...
    {
        "shopName": "육개장인",
        "location": "대륭포스트 타워6차 지하 1층",
        "category": "KOREAN",
        "menu": [
            {"name": "육개장", "price": 10000}
        ],
        "review": "육개장은 여기가 제일 최고인듯 진짜 맛있음"
    },
    {
        "shopName": "순배 순댓국",
        "location": "대륭포스트 타워6차 지하 1층",
...
for restaurant_data in restaurant_data_list:
    ...
    print(f"리뷰: {restaurant_data['review']} ")
